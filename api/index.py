...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "9ECAC"  # Playfab Title Id
        self.SecretKey: str = "UXHANEYKN1HM5ASRCAZOGIUEDDQA9GYTMA8OQHNBCMIXOSQ5M8"  # Playfab Secret Key
        self.ApiKey: str = "OC|1177204918799809|8f3dd739911dd506b189a8925be174bc"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>DISCORD.GG/cJEsJUhftC</color>",
        "BundleKioskButton": "<color=#ff4141>DISCORD.GG/cJEsJUhftC</color>",
        "BundleKioskSign": "<color=#ff4141>DISCORD.GG/cJEsJUhftC</color>",
        "BundleLargeSign": "<color=#ff4141>DISCORD.GG/cJEsJUhftC</color>",
        "SeasonalStoreBoardSign": "<color=red>RATE THE GAME 5 STARS!</color>\n<color=purple>.GG/cJEsJUhftC</color>",
        # Text and Messages
        "EmptyFlashbackText": "FLOOR TWO NOW OPEN\n FOR BUSINESS\n\nSTILL SEARCHING FOR\nBOX LABELED 2021",
        "MOTD": "<color=#FFC0CB>WELCOME TO PROJECT HARMONY!</color>\n\n<color=#0099c2>CURRENT UPDATE: CANT SEA ME 24</color>\n<color=#cacfd2>BOOST THE DISCORDcolor>\n<color=#41ff80>HARMONY MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: HARMONY</color>\n<color=#ac1a00>OWNERS OF GAME ARE ZEON AND HARMONY</color>\n\n<color=#91A3B0>DISCORD.GG/cJEsJUhftC</color>",
        "TOBAlreadyOwnCompTxt": "DISCORD.GG/cJEsJUhftC",
        "TOBAlreadyOwnPurchaseBundle": "PROJECT HARMONY",
        "TOBDefCompTxt": "DISCORD.GG/cJEsJUhftC",
        "TOBDefPurchaseBtnDefTxt": "PROJECT HARMONY",
        # Legal and Versions
        "EnableCustomAuthentication": True,
        "LatestPrivacyPolicyVersion": "2024.09.20",
        "LatestTOSVersion": "2024.09.20",
        "TOS_2024.09.20": "DISCORD.GG/cJEsJUhftC",
        ...
        "NewsFeedUrl": "DISCORD.GG/cJEsJUhftC",
        ...
        "BanAppealUrl": "DISCORD.GG/cJEsJUhftC",
        ...
        "FeedbackSubmissionUrl": "DISCORD.GG/cJEsJUhftC/feedback"
    }
